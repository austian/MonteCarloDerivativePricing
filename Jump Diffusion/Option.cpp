...
void CallOption::MontePrice(std::vector<double>* Data, Stats& Stats, Parameters& Parameters)	{
...
double CallOption::JDPrice(long DegOfAcc, Parameters& _Parameters, Option& Option)	{
	...
	Parameters* Clone = new Parameters(_Parameters.Expiry, _Parameters.Rate, _Parameters.Spot, _Parameters.Vol, _Parameters.NumberOfPaths, _Parameters.NumberOfSteps, _Parameters.Jump);
